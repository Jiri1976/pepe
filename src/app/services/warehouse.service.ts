...
export class WarehouseService {
  ...
  getWarehouseCard(
    ...
    const url =
      this.BASE_ROUTE +
      `GetWarehouseCard?monthYear=${monthYear}&destination=${destination}&warehouseItemId=${warehouseItemId}`;
    return this.http.get<Response>(url);
  }
  ...
  getWarehouseCards(monthYear: string, destination: string) {
    const url =
      this.BASE_ROUTE +
      `GetWarehouseCards?monthYear=${monthYear}&destination=${destination}`;
    return this.http.get<Response>(url);
  }
  ...
  deleteWarehouseCards(monthYear: string, destination: string) {
    const url =
      this.BASE_ROUTE +
      `deleteWarehouseCards?monthYear=${monthYear}&destination=${destination}`;
    return this.http.delete<Response>(url);
  }
}
